...
public class StudentServiceImpl implements StudentService {
	...
	@SyncDbToEs(index = EsCommon.ES_INDEX, type = EsCommon.TABLE_STUDENT, operationType = EsCommon.OPERATE_TYPE_DELETE)
	...
	// 保存学生信息
	@SyncDbToEs(index = EsCommon.ES_INDEX, type = EsCommon.TABLE_STUDENT, operationType = EsCommon.OPERATE_TYPE_ADD)
	...
	@Override
	public List<Student> findAllByParams(Map<String, Object> params) {
		// TODO Auto-generated method stub
		return studentMapper.selectAllByParams(params);
	}
}
